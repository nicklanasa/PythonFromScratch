...
def evaluate_algorithm_with_metric_algorithm(train_dataset,
                                             test_dataset,
                                             algorithm,
                                             metric_algorithm,
                                             *args):
...
def tt_evaluate_algorithm_with_metric_algorithm(dataset,
                                                algorithm,
                                                metric_algorithm,
                                                split,
                                                *args):
...
def cv_evaluate_algorithm_with_metric_algorithm(dataset,
                                                algorithm,
                                                metric_algorithm,
                                                n_folds,
                                                *args):
